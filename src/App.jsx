...
const App = () => {
  ...
  return (
    <Routes>
      ...
      <Route path={'/sell'} element={<Sell properties={properties}/>} />
      <Route path={'/about'} element={<About properties={properties}/>} />
      <Route path={'/contact'} element={<Contact properties={properties}/>} />
